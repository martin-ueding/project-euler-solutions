...
def solution_set() -> int:
    multiples_of_3 = {i * 3 for i in range(1, 1000 // 3 + 1)}
    multiples_of_5 = {i * 5 for i in range(1, 1000 // 5 + 1)}
...
def solution_closed_form() -> int:
    return (
        sum_of_natural_numbers(1000, 3)
        + sum_of_natural_numbers(1000, 5)
        - sum_of_natural_numbers(1000, 15)
    )
